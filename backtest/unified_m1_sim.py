...
def main():
    ...
    for group_name, event_names in event_groups.items():
        ...
        for d in dates:
            ...
            # Extract the actual spike during the expected news hours for this date
            if group_name == "FOMC":
            ...
            # Assume optimal bias to test mechanical viability of the M1 trail
            bias = "BUY" if news_bar_row["close"] > entry_price else "SELL"
            
            pnl_usd = simulate_m1_trade(entry_price, bias, news_bar_row, 2.5, 5.0, 2.0)
